...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.linear_layer = self.VanillaNeuralNetwork(model_dim)
        self.first_layer = nn.LayerNorm(model_dim)
        self.second_layer = nn.LayerNorm(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.attn(self.first_layer(embedded))
        embedded = embedded + self.linear_layer(self.second_layer(embedded))
